...
return [
    ...
    */
    ...
    'discord_app' => [
        ...
        'user_redirect' => env('DISCORD_APP_USER_REDIRECT_URI'),
        'guild_redirect' => env('DISCORD_APP_GUILD_REDIRECT_URI'),
        'guild_install_permissions' => env('DISCORD_GUILD_INSTALL_PERMISSIONS', env('PERMISSION_INTEGER')),
    ],
