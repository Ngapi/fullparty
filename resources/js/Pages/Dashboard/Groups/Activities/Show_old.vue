...
import type { ActivityDetails, ActivityManagementPageProps, ActivityManagementPatch, SlotDesignation } from "../../../../Types/ActivityManagement";
...
const props = defineProps<ActivityManagementPageProps>();
